...
- [ ] Alizia tiene contexto del documento completo (secciones, materias, plan de clases, topics)
- [ ] Las modificaciones via chat se aplican inmediatamente al documento
- [ ] Solo funciona en documentos `draft` (no published ni archived)
...
- [Épica 6: Asistente IA](../../06-assistente-ia/06-asistente-ia.md) — Azure OpenAI con function calling
...
- Materias con sus topics y class_count
...
- 4.28: Chat en documento published → 403
