...
type GetDocument interface {
	Execute(ctx context.Context, orgID, docID int64) (*entities.CoordinationDocument, error)
}
...
func (uc *getDocumentImpl) Execute(ctx context.Context, orgID, docID int64) (*entities.CoordinationDocument, error) {
