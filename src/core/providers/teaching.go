...
type TeachingProvider interface {
	...
	GetLessonPlan(ctx context.Context, orgID, planID int64) (*entities.LessonPlan, error)
	UpdateLessonPlan(ctx context.Context, plan *entities.LessonPlan) error
	ListLessonPlans(ctx context.Context, orgID, coordDocClassID int64) ([]entities.LessonPlan, error)
